...
class KeepColumnValues(beam.DoFn):
    ...
    are retained. This é particularmente útil para limpeza de dados e pré-processamento,
    onde você pode querer excluir registros com base em certos critérios.
    ...
    def __init__(self, column, values_to_filter):
        """
        Initializes the KeepColumnValues instance with the column name and values to filter.
